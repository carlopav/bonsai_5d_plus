...
**Coerenza tra documenti.** Il **Quadro di Incidenza Manodopera** riusa le stesse funzioni di somma del BoQ per la colonna del costo totale, così ogni importo — voce, sezione, totale generale — coincide con il BoQ della stessa schedule, in entrambe le modalità. L'**analisi prezzi** segue già la regola per costruzione: i totali di categoria, il totale tecnico e i ricarichi sommano i `line_total` già arrotondati a 2 decimali (il solo P.U., derivato, resta nella tolleranza sull'eval).
